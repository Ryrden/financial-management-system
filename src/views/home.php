                ...
                <form action="<?=BASE_URL."/transaction/update"?>" method="post">
                    <div class="modal-body d-flex flex-column">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="modalValor" name="valor" placeholder="00.00">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="container py-3 gap-2">
                            ...
                            <form action="<?=BASE_URL."/transaction/insert"?>" method="post" class="d-flex flex-column">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="valor" name="valor" placeholder="00.00">
                                </div>
                                <div class="form-group">
