                ...
                <div class="container">
                    <div class="row align-items-center">
                        <ul class="col-md-9 col-sm-9 nav justify-content-center justify-content-sm-start">
                            <li><a class="nav-link text-light" href="<?=BASE_URL?>">Home</a></li>
                            <li><a class="nav-link text-light" href="<?=BASE_URL."/questionario"?>">Questionário</a></li>
                            <li><a class="nav-link text-light" href="<?= BASE_URL."/documentos" ?>">Docs</a></li>
                        </ul>
